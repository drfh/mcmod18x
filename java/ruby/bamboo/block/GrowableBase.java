...
public abstract class GrowableBase extends BlockBush implements IGrowable {
	...
	public float getGrowRate(Block block, World world, BlockPos pos) {
		...
		{
			boolean flag2 = block == world.getBlockState(blockpos4.north()).getBlock() || block == world.getBlockState(blockpos5.north()).getBlock()
					|| block == world.getBlockState(blockpos5.south()).getBlock() || block == world.getBlockState(blockpos4.south()).getBlock();
